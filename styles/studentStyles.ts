...
export const styles = StyleSheet.create({
    ...
    mainActionCard: { flex: 1, backgroundColor: '#0F0F17', borderRadius: 12, padding: 20, alignItems: 'center' },
    mainActionText: { color: '#fff', marginTop: 8, fontWeight: '600' },
    secondaryActionCard: { flex: 1, backgroundColor: '#fff', borderRadius: 12, padding: 20, alignItems: 'center', borderWidth: 1, borderColor: '#EEE' },
    secondaryActionText: { color: '#333', marginTop: 8, fontWeight: '600' },
    searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#EEE', borderRadius: 10, paddingHorizontal: 15, height: 45, marginBottom: 25 },
    searchInput: { flex: 1, marginLeft: 10 },
    sectionTitle: { fontSize: 18, fontWeight: '700', marginBottom: 15 },
    shopCard: { backgroundColor: '#fff', borderRadius: 15, padding: 20, borderWidth: 1, borderColor: '#F0F0F0', marginBottom: 15 },
