...
export default function RegisterScreen() {
    ...
    const handleRegistration = async () => {
        ...
        try {
            ...
            // This creates the account in auth.users
            ...
            // 2. CREATE PROFILE in your custom 'users' table
            // We use the ID generated by Supabase Auth to link the two
            const { error: profileError } = await supabase
                .from('users')
                .insert([
                    {
                        id: authData.user.id, // The UUID from Auth
            ...
            // 3. SAVE DATA LOCALLY
            // Note: Supabase automatically logs the user in after signup 
            // unless you have email confirmation enabled.
            const role = "student";
            await AsyncStorage.multiSet([
                ["role", role],
