...
//         // Match backend status to your UI colors
...
//                 <Text style={styles.orderFileName}>{item.file_name}</Text>
...
//                         <Text style={{ color: "#888" }}>No orders found yet.</Text>
//                     </View>
//                 )}
//             />
//             {/* ... keep your BottomNav code here ... */}
//         </View>
//     );
// }
